...
import styles from './MusicBarOp.css';
...
class MusicBarOp extends React.Component{
    constructor(props){
        super(props);
        this.state={
    ...
    render(){
        ...
        return(
            <div className={classNames(this.props.className, styles.Section)} style={{zIndex:'1'}}>
...
MusicBarOp.defaultProps = {
    length:'00:00',
    elapsedTime:0,
    duration:0,
};

export default injectObgCom(MusicBarOp);